...
let tempTodos = [];
let allTodos = 0;
const getToDosFromLocalStorage = localStorage.getItem((0, _constants.TODOS_CONST));
...
inputAdd.value = "";
const createToDoItem = ({ title , id: id1 , isDone: isDone1 , date: date1  })=>{
    return `<li class="list-item">
  <div class="item-todo">
      <input type="checkbox" class="form-check-input" id = "${id1}" ${isDone1 && 'checked="true"'}/>
      <label  class="form-check-label" for="${id1}">${title}</label>
      <button class="bg-img" id=${id1} type="button"></button>
      <span class="input-date" id = "date" value = "" >${date1}</span>
  </li>`;
...
},{"./constants":"8eIVP","./localStorageAPI":"2hn77"}],"8eIVP":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TODOS_CONST", ()=>TODOS_CONST);
...
},{}],"2hn77":[function(require,module,exports) {
var _constants = require("./constants");
const setToDosInLocalStorage = (todos)=>{
    localStorage.setItem((0, _constants.TODOS_CONST), JSON.stringify(todos));
};
module.exports = {
    setToDosInLocalStorage
};

},{"./constants":"8eIVP"}]},["awEvQ","bB7Pu"], "bB7Pu", "parcelRequire5b66")
